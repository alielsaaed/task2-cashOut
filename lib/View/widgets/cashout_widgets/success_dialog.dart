  ...
  return AlertDialog(
    ...
    content: Column(
      ...
      children: [
        ...
        SizedBox(height: 15,),
        Text('لقد تم وضع طلبك بنجاح',style: TextStyle(color: MyTheme.blackColor,fontSize: 20.spMin,fontFamily: 'IBM Plex Sans Arabic',fontWeight: FontWeight.w500),
        ...
        ElevatedButton(onPressed: (){Navigator.of(context).pop();},
            child: Padding(
              ...
              child: Text('تتبع الطلب', style: TextStyle(color: MyTheme.blackColor,fontSize: 20.spMin,fontWeight: FontWeight.w500,fontFamily: 'IBM Plex Sans Arabic'),),
            ),
        ...
        ElevatedButton(onPressed: (){Navigator.of(context).pop();},
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text('مواصلة التسوق', style: TextStyle(color: MyTheme.yellowColor,fontSize: 20.spMin,fontWeight: FontWeight.w500,fontFamily: 'IBM Plex Sans Arabic'),),
          ),
          style: ElevatedButton.styleFrom(

            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.spMin),
            side: BorderSide(color: MyTheme.yellowColor)
            ),
            backgroundColor: MyTheme.lightWhite,
          ),
        ),
